...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { city: @weather.city, date: @weather.date, description: @weather.description, temperature: @weather.temperature, time: @weather.time, windspeed: @weather.windspeed } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { city: @weather.city, date: @weather.date, description: @weather.description, temperature: @weather.temperature, time: @weather.time, windspeed: @weather.windspeed } }
